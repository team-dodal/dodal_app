...
import 'package:dodal_app/src/common/widget/input/number_input.dart';
...
import 'package:dodal_app/src/create_challenge/widget/thumbnail_image_input.dart';
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';

class CreateChallengeTitlePage extends StatefulWidget {
  const CreateChallengeTitlePage({
    super.key,
    required this.steps,
    required this.step,
  ...
  @override
  State<CreateChallengeTitlePage> createState() =>
      _CreateChallengeTitlePageState();
}

class _CreateChallengeTitlePageState extends State<CreateChallengeTitlePage> {
  ...
  _isSubmitAble() {
    ...
    if (state.recruitCnt < 1) return false;
    return true;
  }
