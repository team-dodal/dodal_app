...
import 'package:dodal_app/src/challenge/chatting/page/challenge_chat_page.dart';
...
class ChallengeRootPage extends StatefulWidget {
  const ChallengeRootPage({super.key});

  @override
  State<ChallengeRootPage> createState() => _ChallengeRootPageState();
}

class _ChallengeRootPageState extends State<ChallengeRootPage>
